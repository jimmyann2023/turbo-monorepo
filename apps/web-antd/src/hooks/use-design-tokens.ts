...
import { convertToRgb } from '@repo-core/shared/color';
import { updateCSSVariables } from '@repo-core/shared/utils';
...
export function useElementPlusDesignTokens() {
  ...
  watch(
    ...
    () => {
      ...
      updateCSSVariables(variables, `__cloud_design_styles__`);
    },
    { immediate: true },
  );
}
